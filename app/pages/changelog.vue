...
<template>
  <div class="py-10">
    <section class="flex flex-col justify-center max-w-5xl mx-auto px-4 md:px-6">
      <div class="flex flex-col justify-center divide-y divide-gray-400 [&>*]:py-16">
        <div
          class="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:ml-[8.75rem] md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-400 before:to-transparent"
        >
            ...
            <div v-if="item.published">
              <div class="flex items-center">
                <div class="flex items-center md:space-x-reverse">
                  ...
                  <time class="text-sm font-medium text-primary-500 ml-[22px] md:ml-0 md:w-28">{{ item.date }}</time>
                </div>
