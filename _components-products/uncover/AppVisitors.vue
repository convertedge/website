...
import AppSocialLogo from "@/components/products/AppSocialLogo.vue";
        ...
        >
          <template #social_networks-data="{ row }">
            <div class="flex gap-2 cursor-pointer">
              <AppSocialLogo v-for="(source, index) of row.social_networks || []" :key="index" :name="source" class="!h-5 !w-5" />
            </div>
          </template>
